import os, sys, mysql.connector, csv, ejemplo24.ejemplo1.operacionesCRUD as operacionesCRUD
...
menu_dic = {
    '1': operacionesCRUD.crear_tabla,
    '2': operacionesCRUD.insertar,
    '3': operacionesCRUD.mostrar,
    '4': operacionesCRUD.actualizar,
    '5': operacionesCRUD.eliminar,
    "6": operacionesCRUD.buscar,
    '0': operacionesCRUD.salir
}
...
def main():
    while True:
        ...
        funcion = menu_dic.get(opcion,operacionesCRUD.default)
